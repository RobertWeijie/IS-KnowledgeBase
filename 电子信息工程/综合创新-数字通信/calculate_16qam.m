%函数：通过输入信噪比、多径信道数目、蒙特卡洛仿真次数、循环前缀比值来计算16-QAM的误码率和无符号率

function [BER,SER] = calculate_16qam(SNR,L,M,CP)
...
x1 = modulation_16qam(bt);%16-QAM调制
...
%七、解调信号，统计误码率
[receive_bt,re_symbol_seq] = demodulation_16qam(y4);%解调
